...
const INTERNAL_ACCOUNTS = [
  ...
  // Melina — accès dashboard (Leads, Projets, Showroom, Intérêts) ; lien Assets masqué côté front
  { email: 'melina.cabral@atom-capital.fr', passwordEnv: 'MELINA_PASSWORD', role: 'admin' },
];
