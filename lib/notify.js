...
function notifyInterest(lead, label, score) {
  const lines = [
...
module.exports = { sendTelegram, notifyHotLead, notifyInterest, notifyAdsLead, notifyStaleDigest, isAdsLead, sourceLabel };
